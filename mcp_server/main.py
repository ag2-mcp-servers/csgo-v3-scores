...
#   timestamp: 2025-06-29T09:35:27+00:00
...
app = MCPProxy(
    ...
    version='1.0',
    servers=[
        {'url': 'http://azure-api.sportsdata.io/v3/csgo/scores'},
        {'url': 'https://azure-api.sportsdata.io/v3/csgo/scores'},
    ],
)
...
@app.get(
    ...
    tags=['competition_overview', 'game_schedule_retrieval'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['game_schedule_retrieval', 'competition_overview'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['membership_management', 'team_structure_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    description=""" Player """,
    tags=['player_profile_access', 'team_structure_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['team_structure_management', 'player_profile_access'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['competition_overview', 'team_structure_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    '/{format}/Teams',
    description=""" Teams """,
    tags=['team_structure_management', 'membership_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
